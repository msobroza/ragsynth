...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| a0 | 100 | 12.844 | 1.000 | - | 0.0834 | 0.54 | 0.07 | 0.687 | [0.63, 0.75] | 0.686 | 0.88 | 0.000 | 0.000 | fail |
| a1 | 100 | 10.536 | 1.000 | - | 0.0719 | 0.87 | 0.14 | 0.748 | [0.69, 0.81] | 0.752 | 0.90 | 0.000 | 0.000 | fail |
| a2 | 100 | 12.361 | 1.000 | - | 0.0889 | 0.50 | 0.14 | 0.687 | [0.60, 0.75] | 0.686 | 0.88 | 0.000 | 0.000 | fail |
| oracle | 18 | 9.210 | 0.646 | - | 0.0044 | 0.92 | 0.11 | 0.750 | [0.48, 0.82] | 0.787 | 0.94 | 1.000 | 0.117 | fail |
...
Dual view (SPEC §8-9): demand-weighted headline nDCG@10 = 0.976 (unweighted 0.976, ESS/N 0.87); per-cluster table below; worst clusters: [0, 7, 3]; zero-query clusters: [5, 6].
